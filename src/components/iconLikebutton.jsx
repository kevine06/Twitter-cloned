...
function IconLikeButton ({ count }) {
  ...
  return (
    <div  className='tweet-action'>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="#f918819f"  width="30" height="20" viewBox="0 0 24 24" stroke="#8111459f" stroke-width="2" stroke-linecap="round" stroke-linejoin="arcs">
